  ...
  return (
    <section className='my-2 w-full relative flex items-center justify-center'>
        ...
        <div id='heroElements' className='absolute flex flex-col items-center text-center gap-10 opacity-0 translate-y-20 p-5 '>
            <p className='text-white text-7xl lg:text-9xl tracking-wider'>Bontà e tradizione dal 1989</p>
            <a id='bFindMore' href='#parallax' className='w-fit p-5 bg-blue-400 hover:bg-blue-500 rounded-md border-black text-white text-5xl border-2 translate-y-10'>SCOPRI DI PIU'</a>
        </div> 
    </section>
  )
}
